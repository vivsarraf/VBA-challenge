       ...
       ' --------------------------------------------
        ...
        GreatDecrease = ws.Cells(2, 11).Value
            ...
            For i = 2 To LastRowColI
                ...
                'For greatest total volume--we need to check if next value is larger--if yes take over a new value and populate ws.Cells
                ...
                'For greatest increase--We need to check if next value is larger--if yes take over a new value and populate ws.Cells
                ...
                'For greatest decrease--We need to check if next value is smaller--if yes take over a new value and populate ws.Cells
